...
<body class="bgColor">
    ...
    <nav class="box1">
        ...
        <?php for ($I = 0; $I < count($List); $I++) {
            ...
            <div class="col">
                <div class="ListTitle">
                    <h2 style="color:white; text-shadow: -1px 1px 2px #0f467c, 1px 1px 2px #0f467c, 1px -1px 5px #0f467c, -1px -1px 5px #0f467c; letter-spacing: 3px; font-family: monospace;"><?php echo $List[$I][1]; ?></h2>
                </div>
